<?php
// Check if the user is already logged in, if yes then redirect them to the sea$
                ...
                <div class="container">
                        ...
                        <div class="row" style="margin-top: -40px">
                                <div class="form-group">
                                        <label class="control-label col-sm-4" form="machine_id"><b>Machine ID :</b></label>
                                        <div class="col-sm-4">
                                                <input type="text" class="form-control" name="search" placeholder="Enter a Six-Digit Machine ID">
                                         </div>
                                         <div class="col-sm-2">
                                                <button type="submit" name="save" class="btn btn-success btn-sm">Submit</button>
                                                <button type="button" onclick="location.href='VIMS-Map.html'" class="cancelbtn">Map</button>
